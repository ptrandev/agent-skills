...
later 768 and 375 passes letterbox inside the frame, which is fine: everything stays visible. Start at 375
...
```bash
# One per scene, immediately before the capture it labels. Inline, never a shell
# function: see the `$1` note in SKILL.md Phase 0.
