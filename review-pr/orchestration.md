...
A single-PR run executes Phases 3 through 9 inline and none of this applies.

`SKILL.md` Phases 0 through 9 describe one PR. This file is the layer above them.
